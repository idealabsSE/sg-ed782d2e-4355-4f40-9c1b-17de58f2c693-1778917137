...
export default function GDPRDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold mb-2">GDPR Compliance Dashboard</h1>
          <p className="text-muted-foreground">Monitor data subject requests, vendor compliance, and retention policies</p>
        </div>
