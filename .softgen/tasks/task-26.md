...
## Checklist
- [ ] Build upload interface for Power of Attorney / Management Mandate documents
- [ ] Implement secure storage of the document with metadata tracked in `authority_verification`
- [ ] Add data extraction and matching logic vs claimed identity
- [ ] Update case party status based on authority verification result
- [ ] Ensure integration with the overall Case Review and Trust Summary
