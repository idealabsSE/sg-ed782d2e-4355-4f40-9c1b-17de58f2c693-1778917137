...
export const translations = {
  en: {
    ...
    nationalLicense: {
      ...
      status: {
        ...
        cancelled: "Cancelled",
        confirmed: "Confirmed",
        manual_entry: "Awaiting Review",
        automation_pending: "Automation Pending",
      },
      form: {
        title: "National License Information",
        description: "Enter the NRA/NRUA registration details for this property.",
        add: "Add National License",
        edit: "Edit National License",
        registrationNumber: "NRA Registration Number",
        registrationNumberHint: "Enter the official NRA or NRUA registration number",
        status: "Status",
        holderName: "Registered Holder Name",
        holderNamePlaceholder: "Name as appears on registration",
        registeredAt: "Registration Date",
        expiresAt: "Expiration Date",
        notes: "Notes",
        notesPlaceholder: "Additional information or verification notes",
        submit: "Save License",
        submitForReview: "Submit for Review",
        success: "Success",
        successDesc: "National license information saved.",
        manualEntrySubmitted: "NRA registration submitted for review. Verification will proceed once confirmed.",
        error: "Error",
        unexpectedError: "An unexpected error occurred.",
        automationPending: "API Automation Pending",
        manualWorkflowActive: "Manual entry workflow is active. Your submission will be reviewed by an admin.",
        reviewRequired: "This entry requires admin review before it will be marked as confirmed.",
      },
    },
    identity: {
      swedish: {
    ...
    auth: {
      ...
      register: {
        ...
        description: "Register to start verifying properties and identities",
        email: "Email",
        emailPlaceholder: "your@email.com",
        password: "Password",
        passwordPlaceholder: "••••••••",
    ...
    nraReview: {
      title: "NRA Manual Entry Review Queue",
      noReviews: "No pending reviews. All manual NRA entries have been confirmed.",
      property: "Property",
      registrationNumber: "Registration Number",
      ...
      actions: "Actions",
      confirm: "Confirm",
      loadError: "Failed to load review queue",
      confirmError: "Failed to confirm entry",
      confirmSuccess: "Entry Confirmed",
      confirmSuccessDesc: "NRA registration has been confirmed and verified.",
      unexpectedError: "An unexpected error occurred",
      authRequired: "Authentication Required",
      authRequiredDesc: "You must be logged in to confirm entries.",
    },
  },
  sv: {
    nav: {
    ...
    auth: {
      ...
      register: {
        ...
        description: "Registrera dig för att börja verifiera fastigheter och identiteter",
        email: "E-post",
        emailPlaceholder: "din@epost.se",
        password: "Lösenord",
        passwordPlaceholder: "••••••••",
        ...
        success: "Klart!",
        successMessage: "Konto skapat! Omdirigerar...",
        hasAccount: "Har du redan ett konto?",
        login: "Logga in",
        errorPasswordMatch: "Lösenorden matchar inte",
        errorPasswordLength: "Lösenordet måste vara minst 6 tecken",
      },
    },
    dashboard: {
  ...
  es: {
    ...
    auth: {
      login: {
        title: "Iniciar sesión en X Trust",
      ...
      register: {
        ...
        description: "Regístrate para comenzar a verificar propiedades e identidades",
        email: "Correo electrónico",
        emailPlaceholder: "tu@correo.com",
        password: "Contraseña",
        passwordPlaceholder: "••••••••",
